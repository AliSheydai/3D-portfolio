...
const ContactSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      dir="rtl"
      className="font-vazir flex items-center justify-center bg-black relative"
      ...
      >
        ...
        >
          <h1 className="text-black md:w-[10rem] w-[20rem] lg:scale-[0.4] sm:scale-[0.25] scale-[0.07] md:font-bold text-sm sm:text-base leading-none mb-5">
            با من قدمی به سوی آینده بردار
          </h1>

          <p className="text-black lg:w-[40rem] w-[20rem] absolute sm:mt-3 mt-1 md:scale-[0.1] scale-[0.068] leading-relaxed">
            توسعه‌دهنده فرانت‌اند با تخصص در ساخت رابط‌های کاربری مدرن و واکنش‌گرا با استفاده از React، Tailwind CSS و تکنیک‌های پیشرفته انیمیشن. تمرکز من بر کدنویسی تمیز و طراحی پیکسل‌به‌پیکسل متمایز است.
          </p>

          <button className="px-10 py-2 rounded-xl bg-black hover:bg-white hover:text-black transition-all duration-500 scale-[0.1] absolute sm:mt-9 mt-7 whitespace-nowrap">
            تماس با من
          </button>
        </div>
      </div>
